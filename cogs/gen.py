...
class Gen:
    ...
    @property
    def poke_gif(self):
        links = ["https://cdn.discordapp.com/attachments/335346728897216512/444111275061149696/oyIXHxY.gif", "https://cdn.discordapp.com/attachments/335346728897216512/444111289099354132/tumblr_nekrs4QeZZ1r4zr6wo1_500.gif", "https://cdn.discordapp.com/attachments/335346728897216512/444111300549935104/giphy.gif", "https://cdn.discordapp.com/attachments/335346728897216512/444111313577312266/2d6462987a325ad10424c95f40a28483.gif", "https://cdn.discordapp.com/attachments/335346728897216512/444111344501784586/tumblr_mibugnXqaz1rx1dfqo1_500.gif"]
        choice_made= random.choice(links)
        return choice_made
    ...
    async def poke(self, ctx, *, args):
        '''Poke gif send, PS: missing args will show up at logs'''
        poke = self.poke_gif
        em = discord.Embed()
        em.set_image(url = "{}".format(poke))
        await ctx.send(content = "**{0} got poked by {1.mention}**".format(args, ctx.message.author), embed =em)
